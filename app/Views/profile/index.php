...
<div class="profile-card">
    ...
    <form action="<?= site_url('profile/update') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="profile-avatar">
            ...
            <label for="avatar" class="btn btn-secondary" style="cursor: pointer;">Pilih Foto Profil</label>
            <input type="file" id="avatar" name="avatar" class="form-control" accept="image/png, image/jpeg, image/gif" style="display: none;">

            <small class="text-secondary mt-2">Kosongkan jika tidak ingin merubah foto.</small>
            <small class="text-secondary">File: JPG, PNG, GIF | Maks: 2MB</small>

            <?php if (session('errors.avatar')) : ?>
                <div class="error-message"><?= session('errors.avatar') ?></div>
            <?php endif ?>
        </div>
